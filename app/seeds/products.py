...
def seed_products():
    ...
    long_sword = Product(title="Long Sword",
                         image="https://3.bp.blogspot.com/-ZnGkRBCP3h0/Ws-EiDXXKxI/AAAAAAAADbY/Ba6RnoNCjMsogGggwL9jp-35xYBo70bsQCLcBGAs/s1600/Balanced%2BGreatsword%2Bof%2BExtermination%2B53%2B%2528of%2Bthe%2BMountains%2B56%2529%2B%2528Dwarf-craft%2BGreat%2BSword%2529.png",
                         price=300,
    ...
    broad_sword = Product(title="Broad Sword",
                          image="https://4.bp.blogspot.com/-k_jT3_NY9uk/Ws-EnpU4foI/AAAAAAAADcU/jKAJNf2nkngui4AKvzSG23JkP7Y-L7E-QCLcBGAs/s1600/Heavy%2BBright%2BSteel%2BGreat%2BSword%2Bof%2BMight.png",
    ...
    dagger = Product(title="Dagger",
                     image="https://3.bp.blogspot.com/-e_rp2d7fFsg/W0z9LZU0oHI/AAAAAAAADxs/g5FTqR-x98UVVPe6E7YKtUMsAjy88ZMmgCLcBGAs/s1600/Anglas%2B%2528Auger%252C%2BDagger%2Bof%2Bthe%2BNight%2529.png",
                     price=150,
    ...
    elven_dagger = Product(title="Elven Dagger",
                           image="https://2.bp.blogspot.com/-gkan2PNlDI8/W00fVWx565I/AAAAAAAAD08/1-vsfzw4y48U3Oo8zFJ__vwRaYFGMCxcACLcBGAs/s1600/Dagger%2Bof%2Bthe%2BFirst%2BAge%2B59%2B%2528Reshaped%2BFA%2B65%2529.png", price=150, description="The back up\
    ...
    hook_sword = Product(title="Hook Sword",
                         image="https://2.bp.blogspot.com/-cJ9EySvp5hs/WqgeVEwtaGI/AAAAAAAADOg/DQO6ST0y73Q9EWKXgt0uoViAX1A_WuRvACLcBGAs/s1600/Scimitar.png", price=325, description="A sword with\
    ...
    falchion = Product(title="Falchion",
                       image="https://4.bp.blogspot.com/-ImRhXaEjZkI/WqgeXKSiEnI/AAAAAAAADOs/yRzYvSGOW48t-Dyp7eudtr2WOPj2T6UNQCLcBGAs/s1600/Sword%2Bof%2BKnowledge%2B%2528LM%2Bexclusive%2529.png",
    ...
    """BOWS"""
    long_bow = Product(title="Longbow", image="https://wow.zamimg.com/uploads/screenshots/normal/211381-farstriders-longbow.jpg",
    ...
    short_bow = Product(title="Shortbow", image="https://wow.zamimg.com/uploads/screenshots/normal/1013267-composite-bow.jpg",
    ...
    night_club = Product(title="Night Club",
                         image="https://1.bp.blogspot.com/-x1aMsB7F06U/W1j677uh6-I/AAAAAAAAENc/8SRg83q0K88cSwMAVV1lOCoF3DPRZW_8QCLcBGAs/s1600/Polished%2BScout%2527s%2BGreat%2BClub.png",
                         price=500,
                         description="A good time, until it's not.", lore="",
                         quantity=7, category_id=1)

    """SHIELDS"""
    wooden_shield = Product(title="Wooden Shield", image="https://1.bp.blogspot.com/-FQLI0UrZjDc/XWgIjamlnrI/AAAAAAAAFIc/96ny6TkIoac6Yp8IEQ84RYs0onYt0uutQCLcBGAs/s1600/Crafted%2BBuckler.png",
                            price=50,
    ...
    aspi = Product(title="Aspi", image="https://1.bp.blogspot.com/-R8vQKwyX9d8/XWf0nlUQ8JI/AAAAAAAAFFg/JB6BrLkArTMslNNyvm0Kosew-JQgZ6ABwCLcBGAs/s1600/Shield%2Bof%2BAnfalas.png",
                   ...
                   category_id=2)
    gondorian_shield = Product(title="Gondorian Shield", image="https://1.bp.blogspot.com/-2t4JSZ5UtGE/XWf0nfhQCiI/AAAAAAAAFFc/6ex4hO02laIyDGvh4u9QSmc1zIJxGuyOgCLcBGAs/s1600/Pack%2Bof%2Bthe%2BAnorien%2BAutumn.png",
                               price=1000,
    ...
    leather_armor = Product(title="Leather Armor",
                            image="http://4.bp.blogspot.com/-BHt4NyluE7g/U_JGVd00e4I/AAAAAAAACVw/zAWll-olyK0/s1600/Aerthain_Swan.png",
                            price=150, description="Light,\
                            durable, and slightly\
                            flame-retardant.", lore="Made from cow.\
                            Depending on the company you keep, can be \
                                multifunctional.",
                            quantity=829, category_id=3)
    orc_armor = Product(title="Orc Armor", image="https://wow.zamimg.com/uploads/screenshots/normal/761325-savage-warrior.jpg",
    ...
    full_plate_armor = Product(title="Full Plate Armor",
                               image="https://1.bp.blogspot.com/-ZLAkWVbFLo8/XneqlU_E98I/AAAAAAAAFlg/ZNiD7740PVQJY_gN-JmmRS6SRyyCAl7JQCLcBGAsYHQ/s1600/Nathrien_Anniversary%2528s%2529.png",
    ...
    legolas_lager = Product(title="Legolas Lager", image="https://wow.zamimg.com/uploads/screenshots/normal/58201-brewfest-pony-keg.jpg",
                            price=5,
